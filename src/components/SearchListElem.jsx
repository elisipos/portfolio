  ...
  return (
    <>
      <motion.div
        ...
        className={`${theme == 'light' ? 'text-black' : 'text-gray-300'} grid grid-cols-2 md:grid-cols-4 justify-items-center m-2 py-2 rounded-lg md:hover:cursor-default hover:cursor-pointer`}>
