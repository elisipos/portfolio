...
const ProfileComp = () => {
  ...
  return (
    <div className="flex justify-center my-10">
      ...
      <div className={`${theme == 'light' ? 'bg-black/5': 'bg-white/10'} w-3/4 lg:w-1/2 flex p-2 rounded-2xl`}>
      
        <div>
          <div className={`${theme == 'light' ? 'border-black' : 'border-white'} w-20 h-20 rounded-full overflow-hidden border-2`}>
